...
1. [Произвести предобработку исходного набора данных о транзакциях.](#преобразование-очистка-и-анализ-данных)
2. [Провести разведывательный анализ данных и выявить основные закономерности.](разведывательный-анализ)
3. [Сформировать набор данных о характеристиках каждого из уникальных клиентов.](#построение-RFM-таблицы-и-поиск-RFM-выбросов)
4. [Построить несколько моделей машинного обучения, решающих задачу кластеризации клиентов, определить количество кластеров и проинтерпретировать их.](#моделирование-и-оценка-качества-моделей)
